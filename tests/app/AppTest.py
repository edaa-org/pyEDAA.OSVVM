...
RUNABLE_MODULE: ClassVar[str] = "pyEDAA.OSVVM.CLI"
CONSOLE_SCRIPT: ClassVar[str] = "pyedaa-osvvm"
...
class Commands(Testcase):
	...
	def test_ProjectCommand(self) -> None:
		print()
		completedProcess = self.RunEntrypoint("project")
		print(completedProcess.stdout)
		print("STDERR: " + "-" * 112)
		print(completedProcess.stderr)

		stdout = stripANSIColorCodes(completedProcess.stdout)
...
class project(Testcase):
	def test_Help(self) -> None:
		print()
		completedProcess = self.RunEntrypoint("help", "project")
		print(completedProcess.stdout)
	...
	def test_ImplementationLogFile(self) -> None:
		print()
		completedProcess = self.RunEntrypoint("project", "--file=tests/data/Stopwatch/toplevel.vdi")
		print(completedProcess.stdout)
