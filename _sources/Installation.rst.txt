.. |PackageName| replace:: pyEDAA.OSVVM
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: bash
               ...
               # Basic pyEDAA.OSVVM package
               pip3 install pyEDAA.OSVVM

               # Alternatively
               python3 -m pip install pyEDAA.OSVVM
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.OSVVM[doc]

               # Alternatively
               python3 -m pip install pyEDAA.OSVVM[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.OSVVM[test]

               # Alternatively
               python3 -m pip install pyEDAA.OSVVM[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.OSVVM[all]

               # Alternatively
               python3 -m pip install pyEDAA.OSVVM[all]
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: powershell
               ...
               # Basic pyEDAA.OSVVM package
               pip install pyEDAA.OSVVM

               # Alternatively
               py -m pip install pyEDAA.OSVVM
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to generate documentation
               pip install pyEDAA.OSVVM[doc]

               # Alternatively
               py -m pip install pyEDAA.OSVVM[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to run unit tests
               pip install pyEDAA.OSVVM[test]

               # Alternatively
               py -m pip install pyEDAA.OSVVM[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with all developer dependencies
               pip install pyEDAA.OSVVM[all]

               # Alternatively
               py -m pip install pyEDAA.OSVVM[all]
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Update pyEDAA.OSVVM
         pip3 install -U pyEDAA.OSVVM

         # Alternatively
         python3 -m pip install -U pyEDAA.OSVVM
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Update pyEDAA.OSVVM
         pip install -U pyEDAA.OSVVM

         # Alternatively
         py -m pip install -U pyEDAA.OSVVM
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Uninstall pyEDAA.OSVVM
         pip3 uninstall pyEDAA.OSVVM

         # Alternatively
         python3 -m pip uninstall pyEDAA.OSVVM
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall pyEDAA.OSVVM
         pip uninstall pyEDAA.OSVVM

         # Alternatively
         py -m pip uninstall pyEDAA.OSVVM
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         python3 -m pip uninstall -y pyEDAA.OSVVM

         # Install from wheel
         python3 -m pip install ./dist/pyEDAA.OSVVM-0.3.0-py3-none-any.whl
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall the old package
         py -m pip uninstall -y pyEDAA.OSVVM

         # Install from wheel
         py -m pip install .\dist\pyEDAA.OSVVM-0.3.0-py3-none-any.whl
